...
static void init_protocol_defaults(struct ndpi_detection_module_struct *ndpi_str) {
  ...
  */
  ...
  ndpi_set_proto_defaults(ndpi_str, 1 /* cleartext */, 0 /* nw proto */, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_FREE_107,
                          ...
                          ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */,
                          0);
  ndpi_set_proto_defaults(ndpi_str, 1 /* cleartext */, 0 /* nw proto */, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_BLACKNUT,
              "Blacknut", NDPI_PROTOCOL_CATEGORY_STREAMING, NDPI_PROTOCOL_QOE_CATEGORY_UNSPECIFIED,
              ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
              ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */,
              0);
  ndpi_set_proto_defaults(ndpi_str, 1 /* cleartext */, 0 /* nw proto */, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_BOOSTEROID,
              "Boosteroid", NDPI_PROTOCOL_CATEGORY_STREAMING, NDPI_PROTOCOL_QOE_CATEGORY_UNSPECIFIED,
              ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),
              ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0),
              0);

  ndpi_set_proto_defaults(ndpi_str, 1 /* cleartext */, 0 /* nw proto */, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_RUMBLE,
              "Rumble", NDPI_PROTOCOL_CATEGORY_STREAMING, NDPI_PROTOCOL_QOE_CATEGORY_UNSPECIFIED,
              ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),
              ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0),
              0);
